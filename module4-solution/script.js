...
//
// L'idée de cette affectation est de prendre un tableau de noms existants
// puis affichez Bonjour 'Nom' ou Au revoir 'Nom' sur la console.
// Le programme doit dire "Bonjour" à n'importe quel nom sauf les noms qui ont été créés par un "J"
...
// Développer tout le contenu de script.js dans un IIFE
...
for ( var i =   0 ; i <   names . length ; i ++ ) {
  ...
  // noms connus par des majuscules ou des minuscules 'J' / 'j', appel
